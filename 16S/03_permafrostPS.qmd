...
ps.samples |> 
  ...
  tax_agg(rank = "Genus") |> 
  ord_calc("PCA") |> 
  ord_plot(shape = "depth", color = "inc_time_d_fct") +
  facet_wrap(.~inc_temp_C_str, scales = "free") +
  geom_point(size = 3, aes(color = inc_time_d_fct, shape = depth)) +
