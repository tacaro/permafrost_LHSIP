...
We calculate the number of moles per mL of gas, then the number of µg per mL of gas
The MW of $CH_4$ is 16.04 g/mol. The MW of CO2 is 44.01 g/mol.
...
gc_samples_processed |> 
  ...
  facet_wrap(vars(site, gas), scales = "free_y", ncol = 2) +
  theme_bw() +
  labs(
    x = "∆t (Days)",
